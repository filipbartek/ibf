...
\todo[inline]{Nečísluj bonusové slajdy.}
...
\begin{frame}{Intervalové funkce}
$$
\text{binární vektor délky $n$} \sim \text{$n$-bitové celé číslo}
$$
...
$$f_{\interval{000}{001}, \interval{011}{110}}$$
...
\todomaybe[inline]{Definuj pokrytí.}
