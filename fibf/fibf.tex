...
we can define $n$-ary Boolean function
as a function from numbers in $\{0, \ldots, 2^n - 1\}$ to the Boolean domain.
We continue to define \emph{false point interval Boolean function}
as a function whose false points,
...
I will build on the results on true point interval Boolean functions
