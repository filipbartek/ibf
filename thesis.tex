...
\todo[inline]{Priorities: 2int2switch, essential sets}
...
\todomaybe[inline]{Use a different citation style.}
...
\todo[inline]{Change all references to \emph{cref} from \emph{autoref}.}
