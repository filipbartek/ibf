...
The concept of switch was introduced by \husek{}
\cite{Husek2014,Husek2015}.\footnote{
\husek{} first used the Czech term
\quot{\foreignlanguage{czech}{zlom}}
in his thesis \cite[p.~13]{Husek2014}
and later translated the term as \quot{switch}
in personal communication \cite{Husek2015}.
}

\begin{definition}[$l$-switch function]
\todo{Move definition to Definitions?}
...
a size-conservative
\todo{Consider rewording, e.g.~\quot{size-preserving}.}
bijection
...
However,
\dubovsky{} has identified a $3$-switch function
