...
$$
\todo{Prove correctness if the proof is short.}
...
\label{tab:xyc}
\end{table}
\todo{Use taller rows in the table.}
\todo{Use a different emphasis for the matching subvectors in the table. Underline may get mistaken for complement. Try dash underline.}
...
\todo{Napiš explicitně, na který interval redukuji - $\interval{\compl{b}}{\compl{a}}$.
Zamysli se, jestli se dá zformulovat obecně pro obě tyto aplikace.}
