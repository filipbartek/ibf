...
\todo{Is it easy to see at this point?}
...
\todo{Note \quot{size-preserving}. Is it useful?}
1-1
...
Clearly $|V| = |\mathcal{T}|$.
\todomaybe{Show in detail that vectors created from different 1 bits in $c$ must differ.}
...
%Note that this step can be performed in the trivial and prefix and suffix cases as well as preprocessing.
