...
\todo{Clarify what $\valuation{\mathcal{F}}{x}$ means?}
\todo{Rewrite; should be more natural or use the bijection explicitly.}
...
\todo{Is there a better, more established term?}
...
denoted $\compl{\alpha}$,
is $1 - \alpha$.
\todokucera{\foreignlanguage{czech}{Pokud neřeknete, jak jsou reprezentována záporná čísla, tak tento zápis nedává smysl.}}
