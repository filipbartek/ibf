...
% TODO: Find out whether I should also include the same information in Czech.
%       The official style guide seems to suggest that this would be correct.
...
Abstract:
\Abstract
\todomaybe[inline]{Remove citation from abstract.}
